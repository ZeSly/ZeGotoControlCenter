...
namespace ASCOM.ZeGoto
{
    ...
    public static class Server
    {
        ...
        private static string s_appId = "{55b46cfd-7027-41c5-8408-1b398fb61780}";	// Our AppId
        ...
        public static int CountObject()
        {
            ...
            int ret = Interlocked.Increment(ref objsInUse);
            if (OnConnect != null) OnConnect(true, objsInUse);
            return ret;
        }
        ...
        public static int UncountObject()
        {
            ...
            int ret = Interlocked.Decrement(ref objsInUse);
            if (OnConnect != null) OnConnect(true, objsInUse);
            return ret;
        }
            ...
            foreach (FileInfo fi in d.GetFiles("*.dll"))
            {
                ...
                catch (Exception e)
                {
                    MessageBox.Show("Failed to load served COM class assembly " + fi.Name + " - " + e.Message,
                        "ZeGoto", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    return false;
                }
        ...
        private static void ElevateSelf(string arg)
        {
            ...
            {
                MessageBox.Show("The ZeGoto was not " + (arg == "/register" ? "registered" : "unregistered") +
                    " because you did not allow it.", "ZeGoto", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.ToString(), "ZeGoto", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
            return;
        }
                ...
                switch (args[0].ToLower())
                {
                    ...
                    default:
                        MessageBox.Show("Unknown argument: " + args[0] + "\nValid are : -register, -unregister and -embedding",
                            "ZeGoto", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        break;
                }
            }
            else
